...
export const zhCN: Dict = {
  ...
  'workingDirPicker.homeTitle': '选择项目要放在哪个目录下',
  'workingDirPicker.processing': '处理中…',
  'workingDirPicker.select': '选文件夹',
  ...
  'skillPluginCandidate.createForMe': '帮我创建',
  'skillPluginCandidate.contributeToMain': '贡献到主仓库',
  'skillPluginCandidate.publishRepo': '发布仓库',
  ...
  'chat.mode.design.title': 'Design Agent 模式',
  'chat.mode.design.summary': '适合创建或修改具体设计产物，比如网页、原型、实时制品、幻灯片、图片、视频、HyperFrames、音频、数据看板和项目文件。',
  ...
  'chat.designToolbox.tooltip': "设计百宝箱 / Feel lucky",
  'chat.designToolbox.aria': "打开设计百宝箱",
  'chat.designToolbox.lucky': "Feel lucky",
  ...
  'chat.designToolbox.context.liveArtifact': "实时制品",
