...
export const en: Dict = {
  ...
  'settings.byokNoFileToolsNotice':
    "BYOK can't read, write, or edit project files. Use Local CLI when you need code changes.",
  ...
  'settings.azureModelFetchHint':
    'Enter the deployment name from your Azure resource. Azure deployments can’t be fetched automatically.',
  ...
  'chat.mode.chat.title': 'Chat mode',
  ...
  'chat.mode.design.title': 'Design Agent mode',
  ...
  'chat.designToolbox.tooltip': "Design toolbox / Feel lucky",
